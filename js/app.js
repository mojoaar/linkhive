...
LinkHive.App = (function () {
  ...
  function mapDomRefs() {
    ...
    LinkHive.DOM = {
      ...
      settingsCheckDeadLinksBtn: qs('#settingsCheckDeadLinksBtn'),
      settingsCancelDeadLinksBtn: qs('#settingsCancelDeadLinksBtn'),
      deadLinkStatus: qs('#deadLinkStatus'),
...
LinkHive.Sync = (function () {
  ...
  function _pushToGithub() {
    ...
    var pushFile = function (path, data) {
      return client.getFile(path).catch(function (e) {
        if (typeof e.message === 'string' && e.message.indexOf('404') !== -1) return null;
